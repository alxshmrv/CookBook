...
namespace CookBook.Configuration.Politics
{
    public class RecipeOwnerRequirementHandler(IHttpContextAccessor accessor)
        : AuthorizationHandler<RecipeOwnerRequirement>
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, RecipeOwnerRequirement requirement)
        {
